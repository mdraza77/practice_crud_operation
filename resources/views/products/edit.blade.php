...
<body>
    ...
    <form action="{{ route('products.update', $products->id) }}" method="POST">
        ...
        @method('PUT')
        <div class="m-2">
            <input class="border" type="text" name="product_name" id="" value="{{$products->product_name}}" placeholder="Enter Product Name" value="{{$products->product_details}}">
            @error('product_name')
        ...
        <div class="m-2">
            <textarea name="product_details" id="" cols="30" class="border" placeholder="Enter Product Details"
                rows="1">{{$products->product_details}}</textarea>
